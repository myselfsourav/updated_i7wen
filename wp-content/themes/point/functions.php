...
function mts_enqueue_css() {
	...
	wp_enqueue_style( 'GoogleFonts', '//fonts.useso.com/css?family=Droid+Sans:400,700');
	wp_enqueue_style( 'GoogleFonts2', '//fonts.useso.com/css?family=Open+Sans:400,700');
	*/
...
// RLEE stuff, includeing chinese video embed
include("functions/rlee.php");
...
function mts_pagination($pages = '', $range = 3) { 
    ...
    if(1 != $pages) { 
        ...
        if($paged > 2 && $paged > $range+1 && $showitems < $pages) 
            echo "<li><a rel='nofollow' href='".get_pagenum_link(1)."'>&laquo; 第一页</a></li>";
        if($paged > 1 && $showitems < $pages) 
            echo "<li><a rel='nofollow' href='".get_pagenum_link($paged - 1)."' class='inactive'>&lsaquo; 上页</a></li>";
        for ($i=1; $i <= $pages; $i++){ 
        ...
        if ($paged < $pages && $showitems < $pages) 
            echo "<li><a rel='nofollow' href='".get_pagenum_link($paged + 1)."' class='inactive'>下页 &rsaquo;</a></li>";
        if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) 
            echo "<li><a rel='nofollow' class='inactive' href='".get_pagenum_link($pages)."'>最后 &raquo;</a></li>";
            echo "</ul></div>"; 
    }
}
...
//RLEE
function rlee_after_pagination() {
  $rlee_text = "";
  $rlee_text = apply_filters('rlee_after_pagination', $rlee_text);
  echo $rlee_text;
}
?>
